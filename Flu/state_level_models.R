...
for (i in seq(1, length(MA_KNN_GNAR[[3]]))){moran_I_permutation_test(data=flu_norm_ts_moran_MA, county_index =MA_KNN_GNAR[[1]], g=MA_KNN_GNAR[[3]][[i]] ,name=paste("KNN", i, sep = "_"))}
